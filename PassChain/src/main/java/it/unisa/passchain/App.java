...
public class App 
{
 ...
 public static void main( String[] args ) throws MqttException {
     ...
     myClient = new MqttAsyncClient("tcp://192.168.1.58:1883", UUID.randomUUID().toString());
     ...
     myClient.subscribe("notification", 0);
	 ...
	 if(parola.equals("ora"))
		 myClient.publish("notification", message);    // publishes the message to the topic(test/topic)
